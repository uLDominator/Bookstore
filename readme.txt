...
You can then access your abc.jsp page from http://georgia.eng.utah.edu:8080/~cs5530uxx/abc.jsp. And inside your abc.jsp page, you can import your java class (see orders.jsp for an example).
